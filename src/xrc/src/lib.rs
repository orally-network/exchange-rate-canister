...
const PRIVILEGED_CANISTER_IDS: [Principal; 4] = [
    // Pythia stage: xmz4o-gqaaa-aaaag-qcjva-cai
    Principal::from_slice(&[0x00, 0x00, 0x00, 0x00, 0x00, 0xd0, 0x12, 0x6a, 0x01, 0x01]),
    // Sybil stage: tysiw-qaaaa-aaaak-qcikq-cai
    Principal::from_slice(&[0x00, 0x00, 0x00, 0x00, 0x01, 0x50, 0x12, 0x15, 0x01, 0x01]),
    // Pythia prod: ettff-uaaaa-aaaag-abpcq-cai
    Principal::from_slice(&[0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0x0b, 0xc5, 0x01, 0x01]),
    // Sybil prod: wth3l-tiaaa-aaaap-aa5uq-cai
    Principal::from_slice(&[0x00, 0x00, 0x00, 0x00, 0x01, 0xe0, 0x07, 0x69, 0x01, 0x01]),
];
