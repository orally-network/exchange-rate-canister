...
mod test {
    ...
    fn get_url() {
        ...
        assert_eq!(query_string, wrap_url("https://eservices.mas.gov.sg/api/action/datastore/search.json?resource_id=95932927-c8bc-4e7a-b484-68a66a24edfe&limit=100&filters[end_of_day]=2022-08-26"));
    }
